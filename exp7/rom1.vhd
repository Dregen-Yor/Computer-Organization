...
BEGIN
	...
	GENERIC MAP (
		...
		lpm_hint => "ENABLE_RUNTIME_MOD=YES,INSTANCE_NAME=romd",
		lpm_type => "altsyncram",
		numwords_a => 64,
		operation_mode => "ROM",
		outdata_aclr_a => "NONE",
...
-- Retrieval info: PRIVATE: JTAG_ID STRING "romd"
...
-- Retrieval info: CONSTANT: LPM_HINT STRING "ENABLE_RUNTIME_MOD=YES,INSTANCE_NAME=romd"
